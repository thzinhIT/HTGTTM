...
const Footer = () => {
  ...
  return (
    <footer>
      <div className="bg-[rgb(0,93,194)]">
        {" "}
        <div
          style={{ backgroundImage: `url(${bgImage})` }}
          className="w-[1420px] min-h-96 bg-bottom bg-no-repeat bg-cover  py-5 pb-15 mx-auto "
        >
              ...
              <ul className="flex gap-7 ">
                <li className="flex flex-col w-[33%]">
                  ...
                  <div className="text-white mt-2 mb-4 leading-6 w-[75%]">
                    ...
                    minh, tiện lợi, tốt cho sức khỏe và thân thiện với môi
                    trường.
                  </div>
